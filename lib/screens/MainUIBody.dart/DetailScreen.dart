...
//         /// =========================
//         /// NO INTERNET (AWARD STYLE)
//         /// =========================
//         if (state == ApiStatus.noInternet) {
//           return CommonApiStatusWidget(
//             icon: Icons.wifi_off,
//             title: provider.errorMessage,
//            onRetry: () {
//   if (widget.articleId?.isNotEmpty ?? false) {
...
// final isEmpty =
//     provider.detailStatus == ApiStatus.success &&
//     image.isEmpty &&
//     title.isEmpty &&
//     description.isEmpty;
//         /// =========================
...
//                     (index) {
//                       final lang = detail.availableLanguages[index];
...
//                                 context,
//                                 articleId: lang.articleId.toString(),
