...
class MFAfrica extends StatefulWidget {
  const MFAfrica({super.key});

  @override
  State<MFAfrica> createState() =>
      _MFAfricarogramState();
}

class _MFAfricarogramState extends State<MFAfrica> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return BaseProgramPage(
      ...
      programType: ProgramType.africa,
      bodyBuilder: (context) {
