...
class MFFirstInitiativeProgram extends StatefulWidget {
  const MFFirstInitiativeProgram({super.key});

  @override
  State<MFFirstInitiativeProgram> createState() =>
      _MFFirstInitiativeProgramState();
}

class _MFFirstInitiativeProgramState extends State<MFFirstInitiativeProgram> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return BaseProgramPage(
      ...
      programType: ProgramType.firstLadies,
      bodyBuilder: (context) {
