...
onTapUrl: (url) async {
  ...
  try {
    ...
    debugPrint('Phone launch result: $launched');
  } catch (e) {
...
class _YoutubePlayerWidgetState
  ...
  String extractYoutubeId(String url) {
    try {
      ...
      // https://www.youtube.com/embed/A2pmkne-4jU
      if (uri.pathSegments.contains('embed')) {
        final index = uri.pathSegments.indexOf('embed');
      ...
      // https://www.youtube.com/watch?v=A2pmkne-4jU
      final videoId = uri.queryParameters['v'];
...
//   String prepareHtmlForWidget(String html) {
//     return html
//         // Remove language attribute
//         .replaceAll(RegExp(r'\s+lang\s*=\s*"[^"]*"', caseSensitive: false), '')
//         // Remove direction attribute
//         .replaceAll(RegExp(r'\s+dir\s*=\s*"[^"]*"', caseSensitive: false), '');
//   }
...
//       // widget.html,
//       // widget.isDirect
//       //     ? """<p style=\"margin:0in;\"><span style=\"background-color:white;color:#2980b9;font-size:11.0pt;\"><i><span style=\"border:1pt none windowtext;font-family:Verdana,Geneva,sans-serif;padding:0in;\" lang=\"FR\" dir=\"ltr\">Les « vrais » chiffres ne mentent pas :</span></i></span></p><p style=\"margin:0in;\"><span style=\"background-color:white;color:#2980b9;font-size:11.0pt;\"><span style=\"border:1pt none windowtext;font-family:Verdana,Geneva,sans-serif;padding:0in;\" lang=\"FR\" dir=\"ltr\">La Fondation Merck à travers le Cours de Master sur le Diabète a déclenché l'approche communautaire en moi. Le chapitre le plus important pour moi au cours de cette formation a été l'impact mondial et l'épidémiologie du diabète. Le nombre de personnes atteintes de diabète sans le savoir était trop élevé pour que je reste le même sans agir. En tant que prestataires de la santé, il était révoltant d'entendre qu'environ 60 % des personnes atteintes de diabète en Afrique ne savent même pas qu'elles en sont atteintes. Ces chiffres étaient trop élevés pour moi. J'ai réalisé que je devais participer d'une manière ou d'une autre. J'ai choisi de commencer à éduquer les prestataires de la santé afin que nous puissions constituer une armée de personnes qui comprennent le fardeau de la maladie et son impact sur la communauté. J'ai également choisi d'enseigner aux membres de ma communauté et je commencerai bientôt à faire du dépistage chaque fois que je serai dans la communauté. Ceux qui sont déjà diabétiques bénéficient d'une prise en charge individualisée malgré des ressources limitées.</span></span></p><p style=\"margin:0in;\">&nbsp;</p><p style=\"margin:0in;\"><span style=\"background-color:white;color:black;font-size:11.0pt;\"><span style=\"border:1pt none windowtext;font-family:Verdana,Geneva,sans-serif;padding:0in;\">English Translation:</span></span></p><p style=\"margin:0in;\">&nbsp;</p><p style=\"margin:0in;\">&nbsp;</p><p style=\"margin:0in;\"><span style=\"background-color:white;color:black;font-size:11.0pt;\"><span style=\"border:1pt none windowtext;font-family:Verdana,Geneva,sans-serif;padding:0in;\">Mark Foundation, through the Diabetes Mastercourse has triggered the community approach in me. The most important chapter for me during this training was the global impact and epidemiology of diabetes. As a healthcare worker, it was revolting to hear that about 60% of people with diabetes in Africa do not even know that they have it. Those numbers were too high for me. I realized that I must participate in one way or another. I chose to start educating healthcare workers so that we can build an army of people who understand the burden of the disease and its impact on&nbsp;the community. I also chose to&nbsp;teach my community&nbsp;members&nbsp;and soon will start doing screening whenever I am in the community. Those who are already diabetic, get individualized care despite limited resources.</span></span></p>"""
//       //     :
//            normalizeApiFonts(processedHtml),
//       //       '''<div style="font-family: Times New Roman;">
//       //     <h2>Impact of Merck Foundation Programs</h2>
...
//             } else {
//               debugPrint('Could not open phone dialer: $phoneUri');
//             }
//           } catch (e) {
//             debugPrint('Phone dialer error: $e');
//           }
