      ...
      child: InkWell(
        ...
        child: Column(
          ...
          children: [
            ...
            if (mediaType == MediaType.photoAlbum ||
                type == HomeLayoutType.photoGallery ||
                type == HomeLayoutType.DigitalLibrary)
...
class MediaCardImage extends StatefulWidget {
  ...
  @override
  State<MediaCardImage> createState() =>
      _MediaCardImageState();
}

class _MediaCardImageState
    extends State<MediaCardImage> {
  double? aspectRatio;
