...
class MFEducatingLindaProgram extends StatefulWidget {
  const MFEducatingLindaProgram({super.key});

  @override
  State<MFEducatingLindaProgram> createState() =>
      _MFEducatingLindaProgramState();
}

class _MFEducatingLindaProgramState extends State<MFEducatingLindaProgram> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return BaseProgramPage(
      ...
      programType: ProgramType.educatingLinda,
      bodyBuilder: (context) {
