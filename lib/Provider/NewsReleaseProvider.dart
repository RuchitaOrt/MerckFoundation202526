...
class NewsReleaseProvider extends ChangeNotifier {
  final NewReleaseService _service = NewReleaseService();
  ...
  Future<void> loadInitial(BuildContext context) async {
    ...
    final response = await _service.fetchNewRelease(context, 1);
  ...
  Future<void> loadMore(BuildContext context) async {
    ...
    final response = await _service.fetchNewRelease(context, nextPage);
